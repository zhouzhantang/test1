...
//    { "GPIO", dut_cmd_gpio, "+GPIO='mode'", fdut_cmd_gpio},
    { "TRITUPLE", dut_cmd_trituple_component, "+TRITUPLE='pid,key,mac'", fdut_cmd_trituple_component},
