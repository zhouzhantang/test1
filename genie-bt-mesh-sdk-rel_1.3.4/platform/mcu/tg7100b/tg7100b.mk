...
ifeq ($(genie_wdt_config),1)
GLOBAL_DEFINES += CONFIG_WDT
endif

GLOBAL_CFLAGS += -D_RTE_ -DARMCM0 -DCFG_CP -DCFG_QFN32 -DCFG_SLEEP_MODE="PWR_MODE_NO_SLEEP" -DDEBUG_INFO="1"
GLOBAL_DEFINES += CONFIG_BT_MESH_ADV_BUF_COUNT=20
