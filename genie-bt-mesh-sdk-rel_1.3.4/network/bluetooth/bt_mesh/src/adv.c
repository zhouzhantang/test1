 ...
 */
#if defined(BOARD_TG7100B) || ((defined(CONFIG_BT_TINYCRYPT_ECC)) && (!defined(BOARD_BK3435DEVKIT)) && (!defined(BOARD_TC825X)))
...
{
    s32_t adv_int_min = ((bt_dev.hci_version >= BT_HCI_VERSION_5_0) ? ADV_INT_FAST : ADV_INT_DEFAULT);
...
static void adv_thread(void *p1, void *p2, void *p3)
{
    ...
    while (1)
    {
        ...
        if (IS_ENABLED(CONFIG_BT_MESH_GATT_PROXY) && bt_mesh_gatt_is_user_enabled())
        {
                                             ...
                                             s32_t timeout)
{
    ...
    /* net msg send need resume mesh network while suspended */
...
void bt_mesh_adv_init(void)
{
    ...
    k_thread_create(&adv_thread_data, adv_thread_stack,
                    ...
                    "adv_tx", NULL, NULL, CONFIG_BT_MESH_ADV_PRIO, 0, K_NO_WAIT);
}
