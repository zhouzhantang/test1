...
`switches` 是可连接天猫精灵音箱，同时支持天猫精灵APP控制的多键开关，会用到SIG Model与阿里巴巴Vendor Model。

## 2.源文件路径


```
app/example/bluetooth/switches
app/example/bluetooth/switches/switches_input.h
app/example/bluetooth/switches/switches.c
app/example/bluetooth/switches/switches_queue.h
app/example/bluetooth/switches/switches.mk
app/example/bluetooth/switches/switches_input.c
app/example/bluetooth/switches/switches_queue.c
app/example/bluetooth/switches/switches.h
```
...
工程根目录执行./build.sh bluetooth.switches tg7100b 1就可以编译switches应用
正确编译之后生成烧录文件：out/bluetooth.switches@tg7100b/binary/total_image.hexf
正确编译之后生成OTA文件：out/bluetooth.switches@tg7100b/binary/fota.bin
