...
$(NAME)_SOURCES  := light.c light_driver.c my_adc.c my_key.c my_led.c my_task.c
...
#GLOBAL_DEFINES += CONFIG_BT_MESH_CTRL_RELAY
...
MESH_MODEL_SCENE_SRV = 1

#Enable transition/delay time for Generic Model
#MESH_MODEL_ENABLE_TRANSITION = 1
...
GLOBAL_DEFINES += PROJECT_SW_VERSION=0x00020508
