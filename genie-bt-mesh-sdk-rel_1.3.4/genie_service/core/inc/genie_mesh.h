...
#define GENIE_MESH_INIT_PROVISIONED_DELAY_START_MIN (1 * 1000) //Unit:ms
#define GENIE_MESH_INIT_PROVISIONED_DELAY_START_MAX (2 * 1000) //Unit:ms

#define GENIE_MESH_INIT_PHARSE_II_DELAY_START_MIN (2000)      //Unit:ms
#define GENIE_MESH_INIT_PHARSE_II_DELAY_START_MAX (3 * 1000) //Unit:ms
